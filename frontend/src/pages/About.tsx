    ...
    <div className="flex flex-col gap-10 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-ink-secondary mt-2 leading-relaxed max-w-2xl">
          This platform is built on the <span className="text-ink-primary font-medium">Olist Brazilian E-Commerce
          Public Dataset</span> — real, anonymized orders placed on the Olist marketplace between{' '}
          ...
          product categories. The data is static and does not update beyond September 2018.
        </p>
      </div>

      <section>
        <h2 className="text-lg font-semibold mb-1">Raw source tables</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold mb-1">Analytics schema</h2>
        <p className="text-xs text-ink-muted mb-4">
      ...
      <footer className="text-xs text-ink-muted border-t border-hairline pt-6">
        Source: Olist Store, "Brazilian E-Commerce Public Dataset by Olist" (Kaggle).
      </footer>
    </div>
  )
}
